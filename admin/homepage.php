    ...
    if (!isset($_SESSION['mock_homepage_sections'])) {
        $_SESSION['mock_homepage_sections'] = [
            ...
            'curriculum_intro' => [
                ...
                'content' => 'Mapped to CBSE, NEP 2020 and NCF — strong academic foundations blended with creativity, communication, digital fluency and real-world learning.',
                'image' => '',
            ...
            'inclusivity' => [
                ...
                'image' => '',
                'cta_text' => 'Inclusive Learning',
                'cta_url' => '/special-education',
                'cta_enabled' => 1,
                'sort_order' => 7,
                'is_active' => 1
            ],
            'statistics' => [
                ...
                'content' => 'Kindergarten to Grade 8th Spectrum | 15:1 Max Cohort | 100% Live Online | CBSE Mapped Curriculum | 6 Beyond Domains',
                'image' => '',
                'cta_text' => '',
                'cta_url' => '',
                'cta_enabled' => 0,
