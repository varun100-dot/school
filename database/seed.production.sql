...
INSERT INTO `leadership` (`id`, `name`, `slug`, `designation`, `image`, `short_description`, `bio`, `message`, `sort_order`, `is_active`) VALUES
(3, 'Sharmin Habib', 'sharmin-habib', 'Co-Founder & Director', '/assets/images/Profile_Images/Sharmin_Professional_Profile.webp', 
...
'', 1, 1),
(2, 'Deepak Jain', 'deepak-jain', 'Co-Founder & Director', '/assets/images/Profile_Images/Deepak_Professional_Profile.webp',
...
(1, 'Pragya Jain', 'pragya-jain', 'Co-Founder & Director', '/assets/images/Profile_Images/Pragya_Professional_Profile.webp',
...
(4, 'Rashmi Bhasin', 'rashmi-bhasin', 'Academic Head', '/assets/images/Profile_Images/Rashmi_Professional_Profile.webp',
...
ON DUPLICATE KEY UPDATE name = VALUES(name), slug = VALUES(slug), designation = VALUES(designation), image = VALUES(image), short_description = VALUES(short_description), bio = VALUES(bio), message = VALUES(message), sort_order = VALUES(sort_order), is_active = VALUES(is_active);
