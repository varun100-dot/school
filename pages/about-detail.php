...
if (!$leader && (isset($_GET['debug_db']) || !$db || empty($leader))) {
    $fallbacks = [
        ...
        'rashmi-bhasin' => [
            ...
            'short_description' => 'Rashmi Bhasin is the Academic Head of Zuvio Global School. She is a visionary curriculum thinker and mentor committed to designing personalized, interactive, and child-centered online homeschooling experiences for Nursery to Grade 8.',
